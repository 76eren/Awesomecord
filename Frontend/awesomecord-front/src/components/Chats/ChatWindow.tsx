...
export default function ChatWindow({title, conversationId}: ChatWindowProps) {
    ...
    const sortAsc = useCallback((list: MessageModel[]) => {
    ...
    const handleEditMessage = useCallback((message: MessageModel) => {
    ...
    }), [messages, currentUserId, userById, handleDeleteMessage, handleEditMessage]);
